...
parser.add_argument("segmented_image", type=str, help="segmented image path")
...
if __name__ == '__main__':
    ...
    start = args.original_image
    s_start = args.segmented_image

    #creazione cartella risultati

    if not args.dir:
        newpath = os.path.splitext(start)[0]
    else:
        file_name = ntpath.basename(args.original_image)
        newpath = args.dir
    ...
    #creo cartella relativa al file

    #entro nella cartella newpath/file_name
